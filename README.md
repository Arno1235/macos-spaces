...
- Save a Space's apps and window layout (download icon), then restore it later (reload icon). Restore needs Accessibility permission so windows can be positioned.
